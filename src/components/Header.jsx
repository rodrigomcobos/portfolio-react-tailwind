...
const Header = () => {
    ...
    return (
        <header className='flex py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50 mb-10'>
            <div className='flex flex-wrap items-center justify-between gap-5 w-full'>
                ...
                <div id="collapseMenu"
                    ...
                    <button id="toggleClose" className='lg:hidden fixed top-2 right-4 z-[100] rounded-full bg-white p-3'>
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 fillRule-black" viewBox="0 0 320.591 320.591">
                            <path
                    ...
                    <ul
                        ...
                        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='javascript:void(0)'
                            className='hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>Skills</a>
                        </li>
                        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='javascript:void(0)'
                            className='hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>Services</a>
                        </li>
                        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='javascript:void(0)'
                            className='hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>Portfolio</a>
                        </li>
                        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href='javascript:void(0)'
                ...
                <div className='flex max-lg:ml-auto space-x-3'>
                    ...
                    <button id="toggleOpen" className='lg:hidden'>
                        <svg className="w-7 h-7" fillRule="#000" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
