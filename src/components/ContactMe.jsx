    ...
    return (
        <div className='md:mt-44 mt-24'>
            ...
            <div className="grid sm:grid-cols-2 items-start gap-16 max-w-7xl max-md:max-w-md mx-auto mt-14 px-6">
                <div>
                    <p className="text-md mt-4">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about your project  and provide help.</p>
                    ...
                    <div className="mt-12">
                        ...
                        <ul className="mt-4">
                            <li className="flex items-center">
                                ...
                                <a href="mailto:rodrigomcobos@gmail.com" className="text-[#007bff] text-lg ml-4">
                                    <small className="block">Mail</small>
                                    <strong>rodrigomcobos@gmail.com</strong>
                                </a>
                            </li>
                        </ul>
                    </div>
