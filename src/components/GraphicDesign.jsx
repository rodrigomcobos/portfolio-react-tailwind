            ...
            <div className="flex flex-col flex-grow">
                ...
                <div className="mt-auto">
                    ...
                    {card.link && (
                        ...
                        >
                            <button aria-hidden="false" className="bg-blue-800 hover:bg-transparent hover:text-blue-800 border-2 border-blue-800 transition-all text-white font-semibold text-sm tracking-wide rounded-md px-6 py-2.5">
                                View Demo
                            </button>
                        </motion.a>
                    )}
